...
elementoFormulario.addEventListener("submit", function(event) { // Entra na função quando o formulário for submetido
    ...
    let tipoTransacao = inputTipoTransacao.value // Guarda o atributo value da constante inputTipoTransacao em uma variável
    let valor = inputValor.value // Guarda o atributo value da constante inputValor em uma variável
    let data = inputData.value // Guarda o atributo value da constante inputData em uma variável
